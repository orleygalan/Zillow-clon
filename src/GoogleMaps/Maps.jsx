...
import { googleMapsApiKey, libraries, containerStyle, center } from "./recilMap";
import * as Data from "./bienes_Raices.json";
import RenderizadoHome from "./renderizadoHome";
import { faHeart as solidHeart } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import MenuPrincipal from "../menuPrincipal/menu";
import { MapCelularBuy } from "../componentes/mapCelular";
...
function MapGoogle() {
  ...
  const [icons, setIcons] = useState(Data.bienes_por_vender.map(() => "http://www.pngplay.com/wp-content/uploads/6/Red-Ball-Transparent-PNG.png"));
  ...
  return isLoaded ? (
    <>
      ...
      <div onClick={() => handleCambiadaBurger}>
        {cambiarBurger ? (
          <i onClick={handleSalidaBurgerMenu} className="fa-solid fa-xmark cerrarBurger"></i>
        ) : (
          <i onClick={handleEntradaBurgurMenu} className="fa-solid fa-bars menuBurger"></i>
        )}
        {surgirPopBurger && (
      ...
      {showMap && (
        <GoogleMap
          className="ajustarGoogleMapCelulares"
